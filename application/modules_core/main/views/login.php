...
<head>
    <title>Login Pengguna Sistem eQuiz UKDW</title>
    <!-- Meta Tags -->
    <meta charset="UTF-8" />
    ...
    <div class="signin">
        <div class="signin-body">
			...
			<form action="<?php echo base_url().$form_action ?>" method="POST">
				<div class="msg"><?php echo $this->session->flashdata('login_failed'); ?></div><br>                
				<div class="form-group">
                    <input type="text" class="form-control" placeholder="Gunakan username SSAT" name="username" id="username">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="Password SSAT" name="password" id="password">
                </div>

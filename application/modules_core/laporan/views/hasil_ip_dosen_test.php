...
<ol class="breadcrumb">
    ...
    <li class="active"><?= $dsn->gelar_prefix ?>  <?= $dsn->nama_dsn ?> <?= $dsn->gelar_suffix ?></li>
</ol>
...
<h4>Dosen : <?= $dsn->gelar_prefix ?> <?= $dsn->nama_dsn ?> <?= $dsn->gelar_suffix ?> / <?= $dsn->nik ?> / <?php echo $dsn->unit ?>&nbsp;&nbsp;&nbsp;</h4>
            ...
            <?php else : ?>
           	...
           	<?php endif ?>
                    ...
                    <td style="text-align:right">
                        ...
                        <i class="tooltip-demo"
                        data-original-title="
                        Total mhs dengan nilai A : <?php echo $mtk->tot_nilai_A ?> <br/>
                        Total mhs dengan nilai A- : <?php echo $mtk->tot_nilai_Amin ?> <br/>
                        Total mhs dengan nilai B+ : <?php echo $mtk->tot_nilai_Bplus ?> <br/>
                        Total mhs dengan nilai B : <?php echo $mtk->tot_nilai_B ?> <br/>
                        Total mhs dengan nilai B- : <?php echo $mtk->tot_nilai_Bmin ?> <br/>
                        Total mhs dengan nilai C+ : <?php echo $mtk->tot_nilai_Cplus ?> <br/>
                        Total mhs dengan nilai C : <?php echo $mtk->tot_nilai_C ?> <br/>
                        Total mhs dengan nilai D : <?php echo $mtk->tot_nilai_D ?> <br/>
                        Total mhs dengan nilai E : <?php echo $mtk->tot_nilai_E ?> <br/>
                        Total mhs dengan nilai F : <?php echo $mtk->tot_nilai_F ?> <br/>
                        Total mhs : <?php echo $mtk->tot_mhs ?> <br/>
                        Total mhs lulus : <?php echo $mtk->tot_lulus ?>
                         "
                        data-placement="bottom" data-toggle="tooltip" href="#"
                        title="" data-html="true"><i class="icon-question-sign"></i></i>
                        <?php else : ?>
                        -
                        <?php endif; ?>
                    </td>

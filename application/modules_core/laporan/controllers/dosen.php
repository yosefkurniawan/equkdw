...
class Dosen extends CI_Controller {
	...
	public function hasil_evaluasi($nik,$id_paket = ''){
		...
		if ($id_paket == '') {
			$data['id_paket'] 	= "";
			$periode['thn_ajaran'] 	= $this->m_general->getLastPacket()->thn_ajaran;
			$periode['semester']	= $this->m_general->getLastPacket()->semester;			
			/*
	...
	public function ip_dosen($nik,$id_paket = ''){
		...
		if ($id_paket == '') {
			...
			*/
			...
			$data['periode']['deadline'] 	= $this->m_general->getLastPacket()->deadline_o4;
		}
		else {
			$data['id_paket'] 		= $id_paket;
			$periode['thn_ajaran']	= $this->m_laporan->getPaketList($id_paket)->thn_ajaran;

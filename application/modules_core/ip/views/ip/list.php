		...
		<div class="panel colored" id="list_prodi">
			...
			<div class="panel-heading black-bg">
				<h4 class="panel-title">
					...
					<a href="<?php echo base_url() ?>ip/ip/rangkuman/<?php echo $unit['id_unit']?>/<?php echo $id_paket ?>" class="btn btn-info btn-xs pull-right" target="_blank" style="margin-left:10px;">Cetak Rangkuman</a>
					<a href="<?php echo base_url() ?>ip/ip/export_to_excel/<?php echo $unit['id_unit']?>/<?php echo $id_paket ?>" class="btn btn-info btn-xs pull-right" style="margin-left:10px;">Export Ke Excel</a>
					<a href="<?php echo base_url() ?>ip/ip/detail_dosen_perprodi_pdf/<?php echo $unit['id_unit']?>/<?php echo $id_paket ?>" class="btn btn-info btn-xs pull-right" target="_blank" style="margin-left:10px;">Print Semua Dosen</a>
				</h4>
			</div>
